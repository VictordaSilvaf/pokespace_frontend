...
This collection is more than a folder of images: three JSON files in
`public/assets/sprite-meta/` turn it into a queryable asset library. This
document describes each one.
